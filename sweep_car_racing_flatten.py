...
from car_racing_dqn_flatten import Agent
...
CANDIDATES = [
    ...
    {
        "name": "flatten_low_lr_big_hidden",
        "description": "Lower learning rate with a larger hidden layer.",
        "overrides": {
    ...
    {
        "name": "flatten_more_exploration",
        "description": "Slower epsilon decay with a larger replay buffer.",
        "overrides": {
            "epsilon_decay": 0.997,
            "epsilon_min": 0.02,
    ...
    {
        "name": "flatten_big_hidden_long_horizon",
        "description": "Larger hidden layer, larger batch, and slightly higher gamma.",
        "overrides": {
            "hidden_dim": 512,
            "mini_batch_size": 128,
    ...
    {
        "name": "flatten_small_hidden_quick_decay",
        "description": "Smaller hidden layer and faster exploration decay.",
        "overrides": {
            "hidden_dim": 128,
            "epsilon_decay": 0.993,
            "epsilon_min": 0.05,
    ...
    {
        "name": "flatten_stable_large_batch",
        "description": "Lower learning rate with a larger batch and slower syncing.",
        "overrides": {
            "learning_rate_a": 0.00005,
            "mini_batch_size": 128,
    ...
    {
        "name": "flatten_lower_gamma_quick_sync",
    ...
    {
        "name": "flatten_low_epsilon_floor",
        "description": "Longer exploration with a very low epsilon minimum.",
        "overrides": {
            "epsilon_decay": 0.997,
            "epsilon_min": 0.01,
            "hidden_dim": 256,
    ...
    {
        "name": "flatten_balanced_large_batch",
        "description": "Baseline learning rate with larger batch and slower target sync.",
        "overrides": {
            "mini_batch_size": 128,
            "network_sync_rate": 2000,
            "hidden_dim": 256,
...
def apply_overrides(agent, overrides, run_name, stage_name):
    ...
    sweep_dir = agent.runs_dir / "sweeps" / "flatten" / stage_name
...
def main():
    parser = argparse.ArgumentParser(description="Two-stage hyperparameter sweep for flattened CarRacing DQN.")
    parser.add_argument(
        "--screen-episodes",
        type=int,
        default=50,
    ...
    print("Stage 1: screening flattened DQN candidates.")
    print(
